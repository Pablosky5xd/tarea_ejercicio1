...
function canBuyProduct() {
    ...
    const capital = 1150;
    const prodDesc = producto * descuento;
    const prodConDesc = producto - prodDesc;
    const compraExitosa = capital >= prodConDesc;
    console.log(compraExitosa)
}
...
function checkUserNameType() {
    let userName = 2 + 3; 
    console.log(typeof userName)  // el typeof te dice que tipo de variable es (ej: cadena de texto, numero, etc)
}
